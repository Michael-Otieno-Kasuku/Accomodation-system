...
public class JuaKali implements Locations{
    @Override
    public void AccomodationType() {
        System.out.print(BackgroundColors.YELLOW_BACKGROUND+ FontColors.BLUE+ FontEffects.SET_BOLD_TEXT+"ACCOMMODATION TYPES AVAILABLE IN JUA KALI\n"+FontEffects.SET_PLAIN_TEXT+FontColors.RESET+ BackgroundColors.RESET_BACKGROUND);
    ...
    public void Landlords() {
        System.out.print(FontColors.PURPLE+FontEffects.SET_BOLD_TEXT+BackgroundColors.GREEN_BACKGROUND+"\n LANDLORDS IN JUA KALI\n"+BackgroundColors.RESET_BACKGROUND+FontEffects.SET_PLAIN_TEXT+FontColors.RESET);
        System.out.print(FontColors.RED+"1. TOM STEVE  - 0712345678\n");
        System.out.print("2. DENNIS MORGAN - 0723456788\n");
        System.out.print("3. JACOB ZUMA- 0734567899\n");
        System.out.print("4. ALEX JOB - 0756789028\n");
        System.out.print("5. MICHAEL BOB - 0756789065\n");
        System.out.print("6. PHILIP JORDAN - 075678907644\n"+FontColors.RESET);
    }
