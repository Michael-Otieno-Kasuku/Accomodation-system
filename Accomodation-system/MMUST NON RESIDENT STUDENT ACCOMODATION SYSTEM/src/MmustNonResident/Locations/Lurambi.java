...
public class Lurambi implements Locations{
    @Override
    public void AccomodationType() {
        System.out.print(BackgroundColors.YELLOW_BACKGROUND+ FontColors.BLUE+ FontEffects.SET_BOLD_TEXT+"ACCOMMODATION TYPES AVAILABLE IN LURAMBI\n"+FontEffects.SET_PLAIN_TEXT+FontColors.RESET+ BackgroundColors.RESET_BACKGROUND);
    ...
    public void Landlords() {
        System.out.print(FontColors.PURPLE+FontEffects.SET_BOLD_TEXT+BackgroundColors.GREEN_BACKGROUND+"\n LANDLORDS IN LURAMBI\n"+BackgroundColors.RESET_BACKGROUND+FontEffects.SET_PLAIN_TEXT+FontColors.RESET);
        System.out.print(FontColors.RED+"1. THOMAS STEVE  - 0712345678\n");
        System.out.print("2. MICHAEL JARED - 0723459789\n");
        System.out.print("3. STEVE SMART- 0734567790\n");
        System.out.print("4. RICHARD PETERS - 0756779023\n");
        System.out.print("5. MICHAEL PAUL - 0756789865\n");
        System.out.print("6. PHILIP JOHNSON - 075668907645\n"+FontColors.RESET);
    }
