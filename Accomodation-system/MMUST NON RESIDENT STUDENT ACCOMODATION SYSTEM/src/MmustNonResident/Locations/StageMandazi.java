...
public class StageMandazi implements Locations{
    @Override
    public void AccomodationType() {
        System.out.print(BackgroundColors.YELLOW_BACKGROUND+ FontColors.BLUE+ FontEffects.SET_BOLD_TEXT+"ACCOMMODATION TYPES AVAILABLE IN STAGE MANADAZI\n"+FontEffects.SET_PLAIN_TEXT+FontColors.RESET+ BackgroundColors.RESET_BACKGROUND);
    ...
    public void Landlords() {
        System.out.print(FontColors.PURPLE+FontEffects.SET_BOLD_TEXT+BackgroundColors.GREEN_BACKGROUND+"\n LANDLORDS IN STAGE MANDAZI\n"+BackgroundColors.RESET_BACKGROUND+FontEffects.SET_PLAIN_TEXT+FontColors.RESET);
        System.out.print(FontColors.RED+"1. THOMAS TED  - 0712845678\n");
        System.out.print("2. JACK BRIGHT - 0726456789\n");
        System.out.print("3. STEVE JOB - 0734567890\n");
        System.out.print("4. RICHARD SMITH - 0753789023\n");
        System.out.print("5. MICHAEL TOM - 0756779065\n");
        System.out.print("6. PHILIP DOMNIC - 075578907645\n"+FontColors.RESET);
    }
