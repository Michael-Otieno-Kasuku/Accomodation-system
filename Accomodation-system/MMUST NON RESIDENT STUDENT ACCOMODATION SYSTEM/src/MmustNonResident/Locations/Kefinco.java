...
public class Kefinco implements Locations{
    @Override
    public void AccomodationType() {
        System.out.print(BackgroundColors.YELLOW_BACKGROUND+ FontColors.BLUE+ FontEffects.SET_BOLD_TEXT+"ACCOMMODATION TYPES AVAILABLE IN KAFINCO\n"+FontEffects.SET_PLAIN_TEXT+FontColors.RESET+ BackgroundColors.RESET_BACKGROUND);
    ...
    public void Landlords() {
        System.out.print(FontColors.PURPLE+FontEffects.SET_BOLD_TEXT+BackgroundColors.GREEN_BACKGROUND+"\n LANDLORDS IN KEFINCOn"+BackgroundColors.RESET_BACKGROUND+FontEffects.SET_PLAIN_TEXT+FontColors.RESET);
        System.out.print(FontColors.RED+"1. THOMAS PETERS  - 0712345678\n");
        System.out.print("2. CARL STEVE - 0728456789\n");
        System.out.print("3. STEVE PAUL - 0739567890\n");
        System.out.print("4. RICHARD JOB - 0758789023\n");
        System.out.print("5. MICHAEL JOHNSON - 0756789065\n");
        System.out.print("6. PHILIP KENNEDY - 075878907645\n"+FontColors.RESET);
    }
